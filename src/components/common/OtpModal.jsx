    ...
    if (index === 5 && value) {
      ...
      if (otpValue.length === 6) {
        try {
          ...
          // Handle cases where parent returns false
          // or { success: false }
          if (
            result === false ||
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[#E8EEEE] px-6 py-5">
          ...
          <button
            ...
            onClick={onBack}
            disabled={loading}
            className="flex h-11 w-11 items-center justify-center rounded-full border border-[#E5EEEE] bg-white text-[#183838] shadow-sm transition hover:bg-[#61b9b9] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
            aria-label="Back"
          >
            <ArrowLeft size={18} />
          </button>
        ...
        <div className="p-8">
          ...
          <p className="mx-auto mt-2 max-w-sm text-center text-sm leading-6 text-[#728282]">
            We've sent a secure verification code to your
            mobile number.
          </p>
          ...
          <div className="mt-10 flex justify-center gap-2 sm:gap-3">
            {otp.map((digit, index) => (
              <input
                ...
                className={`h-12 w-10 rounded-xl border bg-[#FCFEFE] text-center text-xl font-semibold text-[#183838] outline-none transition focus:ring-4 sm:h-14 sm:w-12 ${
                  error
                    ? "border-red-400 focus:border-red-400 focus:ring-red-400/10"
                    : "border-[#D8E8E8] focus:border-[#61b9b9] focus:ring-[#61b9b9]/10"
          ...
          <div className="mt-4 flex min-h-[24px] items-center justify-center">
            {error && (
              <div className="flex items-center justify-center gap-2 text-center text-sm font-medium text-red-500">
                <CircleAlert
                  size={16}
                  className="shrink-0"
                />
          ...
          <div className="mt-2 flex h-6 items-center justify-center">
            {loading && (
              <div className="flex items-center gap-2 text-sm font-semibold text-[#61b9b9]">
                <RefreshCw
                  size={17}
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            {timer === 0 ? (
              <button
                ...
                onClick={resendOTP}
                disabled={loading}
                className="flex items-center gap-2 text-sm font-semibold text-[#61b9b9] transition hover:text-[#4EA0A0] disabled:cursor-not-allowed disabled:opacity-50"
              >
                <RefreshCw size={15} />
                Resend
              </button>
          ...
          {/* ================= TERMS ================= */}
          <p className="mt-8 text-center text-xs leading-5 text-[#8A9999]">
            By continuing you agree to our{" "}
            <span className="font-medium text-[#61b9b9]">
              Terms
            </span>{" "}
