...
const CartSidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 z-50 h-full w-full bg-white shadow-lg transition-transform duration-500 md:w-120 lg:w-148 ${
          isSidebarOpen
            ? "translate-x-0"
            : "translate-x-full"
        }`}
            ...
            <>
              ...
              {items.length === 0 ? (
                ...
                <div className="flex flex-1 flex-col items-center justify-center px-10 py-20">
                  ...
                  <h2 className="pb-4 text-center text-2xl font-light text-[#183838]">
                    Your Shopping Bag is Empty
                  </h2>
      ...
      {/* ================================================= */}
      {/* LOGIN MODAL */}
      {/* IMPORTANT: OUTSIDE CART SIDEBAR */}
      {/* ================================================= */}
