    ...
    <>
      <main className="relative box-border h-screen overflow-hidden bg-[#f6fafa] pt-[107px]">
        ...
        <section
          ...
          <div className="grid h-full w-full items-center gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10 xl:gap-14">
            <div className="relative hidden lg:block lg:h-[min(600px,calc(100vh-145px))]">
              {/* Decorative Border */}
              ...
              <div
                className="
                  ...
                  px-4
                  py-3
                  shadow-[0_15px_40px_rgba(45,91,91,0.15)]
                  backdrop-blur-xl
                  xl:-right-6
                "
              >
              ...
              <div className="w-full max-w-[470px]">
                ...
                <div className="mb-5">
                  ...
                  >
                    ...
                    orders, and everything made for you.
                  </p>
                </div>
                ...
                >
                  ...
                  <button
                    ...
                    className="
                      ...
                      font-semibold
                      text-white
                      shadow-[0_12px_30px_rgba(97,185,185,0.25)]
                      transition-all
                      duration-300
                      hover:-translate-y-0.5
                      hover:bg-[#4fa5a5]
                      hover:shadow-[0_16px_35px_rgba(97,185,185,0.32)]
