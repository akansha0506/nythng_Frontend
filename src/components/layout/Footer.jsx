...
import footerBg from "@/assets/images/footer2.png";
...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden text-[#2c5357] font-sans">
      ...
      <div className="relative z-30 max-w-[1240px] mx-auto px-6 md:px-12 pt-28 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="relative flex items-center w-full max-w-[420px] h-[46px] rounded-full bg-white/90 shadow-sm border border-white/80 overflow-hidden p-1">
              ...
              <button className="h-full px-5 rounded-full bg-[#187582] hover:bg-[#115761] text-white text-[13px] font-medium flex items-center gap-2 transition-all duration-200 shrink-0">
          ...
          <div className="lg:col-span-4 lg:border-l lg:border-[#a1d1dc]/70 lg:pl-10">
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              {footerLinks.map((section) => (
                ...
                <div key={section.title}>
                  ...
                  <h2 className="text-[#187582] uppercase font-bold tracking-wider text-[15px] mb-4">
                    {section.title}
                  </h2>
                  ...
                  <ul className="space-y-2.5">
                    ...
                    {section.links.map((link) => (
                      ...
                      <li key={link.label}>
                        ...
                        <Link
                          href={link.path}
                          className="text-[15px] text-[#187582]/80 font-medium hover:text-[#187582] transition-colors"
                        >
                          {link.label}
                        </Link>
      ...
      {/* Divider */}
        ...
        <div className="relative flex items-center justify-center my-10">
          ...
          <div className="absolute px-3 bg-[#bfdee7]/90 rounded-full">
